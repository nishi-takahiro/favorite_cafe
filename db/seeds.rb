...
Article.create!(store_id: '6', user_id: '1', store_name: '鹿の舟 竈 (かまど)', address: '奈良県奈良市井上町１１',store_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-cafe6.jpg"), filename:"sample-cafe6.jpg"), store_comment: '美味しい白米を食べることができます。竈で炊いたご飯を食べることがきるので、ごはんがツヤツヤと輝いていて、甘みが口の中で広がってくれます。',rate_delicious: '5', rate_atmospher: '5', rate_cost: '5')
